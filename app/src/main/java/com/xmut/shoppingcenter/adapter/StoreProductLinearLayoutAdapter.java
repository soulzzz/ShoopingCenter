...
public class StoreProductLinearLayoutAdapter extends RecyclerView.Adapter<StoreProductLinearLayoutAdapter.Myholder>{
    Context context;
    List<Product> productList;
    String productimg;

    public StoreProductLinearLayoutAdapter(Context context, List<Product> productList) {
