...
public class ProductCommentAdapter2 extends RecyclerView.Adapter<ProductCommentAdapter2.Myholder> {
    Context context;
    List<ProductComment> productComments;
    public ProductCommentAdapter2(Context context, List<ProductComment> productComments) {
