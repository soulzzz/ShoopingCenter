...
public class StoreProductGridLayoutAdapter extends RecyclerView.Adapter<StoreProductGridLayoutAdapter.Myholder>{
    Context context;
    List<Product> productList;
    String productimg;

    public StoreProductGridLayoutAdapter(Context context, List<Product> productList) {
